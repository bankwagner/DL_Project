...
def train_model(batch_size, learning_rate, epochs):
    ...
    model = sm.FPN('resnet34', encoder_weights='imagenet', activation='softmax', classes=n_classes)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train the fpn model with custom parameters.")
