...
def create_test_metrics(x_test, y_test, model, model_name):
...
def create_prediction_plot(x_test, y_test, model, model_name):
...
if __name__ == "__main__":
    ...
    create_prediction_plot(x_test, y_test, model, model_name)
    
    create_test_metrics(x_test, y_test, model, model_name)
